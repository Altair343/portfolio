...
const IconsMedia = () => {
    return (
        <div className="icons-socials">
            ...
            <a href="www.linkedin.com/in/andrés-vergara-pech-97a5161a1" target="_blank" rel="noopener noreferrer" className="icons-social behance" ><i class="fab fa-linkedin"></i></a>
        </div>
    )
}
